...
- (void)viewDidLoad
{
    ...
    // 1、 设置导航栏的背景图片
    self.navigation_backgroundImageName = @"stranger_background";
    // 2、设置被拉伸图片view的高度
    self.stretchingImageHeight = 200;
    // 3、设置头部拉伸图片的名称
    self.stretchingImageName = @"stranger_background";
...
{
    YCEditUserInfoViewController *editVC = [[YCEditUserInfoViewController alloc] init];
