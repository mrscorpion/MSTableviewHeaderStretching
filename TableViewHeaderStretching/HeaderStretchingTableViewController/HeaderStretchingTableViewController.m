...
//    self.navigationController.navigationBar.translucent = YES; // Nav显示透明效果
...
//    self.visualEffectView = [[UIVisualEffectView alloc] initWithEffect:blurEffect];
    ...
    self.visualEffectView.frame = self.topView.bounds;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if(self.edgesForExtendedLayout == UIRectEdgeTop || self.edgesForExtendedLayout == UIRectEdgeAll){
        [self.navigationController.navigationBar setBackgroundImage:[self imageByApplyingAlpha:alpha image:self.navigation_background_image == nil?[self imageWithColor:[UIColor blueColor]]:self.navigation_background_image] forBarMetrics:UIBarMetricsDefault];
    }
}
